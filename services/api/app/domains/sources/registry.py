...
SOURCE_REGISTRY = [
    ...
    RegistrySource(
        key="microsoft-earnings-call-fy25",
        company_slug="microsoft",
        title="Microsoft earnings releases and webcasts archive",
    ...
    RegistrySource(
        key="microsoft-investor-presentation-fy25",
        company_slug="microsoft",
        title="Microsoft investor events and presentations archive",
    ...
    RegistrySource(
        key="alphabet-earnings-fy2025",
        company_slug="google",
        title="Alphabet quarterly earnings and webcast archive",
        source_type="earnings_call",
    ...
    RegistrySource(
        key="alphabet-investor-presentation-fy2025",
        company_slug="google",
        title="Alphabet investor events and presentations archive",
        source_type="investor_presentation",
    ...
    RegistrySource(
        key="meta-earnings-fy2025",
        company_slug="meta",
        title="Meta quarterly earnings and webcast archive",
        source_type="earnings_call",
        url="https://investor.atmeta.com/news-events/events-presentations/",
        publisher="Meta Investor Relations",
        published_at=datetime(2026, 2, 1, tzinfo=UTC),
    ),
    RegistrySource(
        key="meta-investor-presentation-fy2025",
        company_slug="meta",
        title="Meta investor events and presentation archive",
        source_type="investor_presentation",
        url="https://investor.atmeta.com/news-events/events-presentations/",
        publisher="Meta Investor Relations",
        published_at=datetime(2026, 2, 1, tzinfo=UTC),
    ...
    RegistrySource(
        key="amazon-earnings-fy2025",
        company_slug="amazon",
        title="Amazon quarterly results and webcast archive",
        source_type="earnings_call",
    ...
    RegistrySource(
        key="amazon-investor-presentation-fy2025",
        company_slug="amazon",
        title="Amazon investor events and presentation archive",
        source_type="investor_presentation",
        url="https://ir.aboutamazon.com/events/default.aspx",
        publisher="Amazon Investor Relations",
        published_at=datetime(2026, 2, 1, tzinfo=UTC),
    ...
    RegistrySource(
        key="nvidia-earnings-fy2025",
        company_slug="nvidia",
        title="NVIDIA quarterly results and earnings call archive",
        source_type="earnings_call",
    ...
    RegistrySource(
        key="nvidia-investor-presentation-fy2025",
        company_slug="nvidia",
        title="NVIDIA investor events and presentations archive",
        source_type="investor_presentation",
