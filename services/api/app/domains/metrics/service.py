...
from app.domains.indexes.service import calculate_ai_reality_index, list_ai_reality_indexes
...
METRIC_DEFINITIONS = [
    ...
    {"key": "revenue_growth", "name": "Revenue Growth", "unit": "ratio"},
    {"key": "gross_margin", "name": "Gross Margin", "unit": "ratio"},
    {"key": "adoption", "name": "Adoption", "unit": "score"},
...
def get_scoreboard(db: Session | None = None) -> dict[str, object]:
    ...
    top_ai_reality_index = (
        list_ai_reality_indexes(db, limit=10)
        if db
        else [
    ...
    return {
        ...
        "confidence": DEFAULT_CONFIDENCE,
        "top_ai_reality_index": top_ai_reality_index,
    }
