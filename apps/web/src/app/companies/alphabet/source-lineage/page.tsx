...
import { fetchAlphabetSourceLineage } from "@/lib/api";

export const metadata: Metadata = {
  title: "Alphabet Source Lineage | APIP",
  description: "Source lineage for published Alphabet APIP metrics."
};

export default async function AlphabetSourceLineagePage() {
  const lineage = await fetchAlphabetSourceLineage();
  return (
