...
import { fetchCompanyTrustReport } from "@/lib/api";
...
export default async function CompanyTrustReportPage({
  ...
  const report = await fetchCompanyTrustReport(id);
  const summary = [
  ...
  return (
    <div className="grid gap-6">
      <header className="grid gap-3 border-b border-border pb-6">
        ...
        <h1 className="text-4xl font-semibold">{report.company ?? id} Trust Report</h1>
