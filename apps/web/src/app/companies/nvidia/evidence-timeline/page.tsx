...
import { fetchNvidiaEvidenceTimeline } from "@/lib/api";

export const metadata: Metadata = {
  title: "NVIDIA Evidence Timeline | APIP",
  description: "End-to-end NVIDIA evidence timeline from collection through publication."
};

export default async function NvidiaEvidenceTimelinePage() {
  const timeline = await fetchNvidiaEvidenceTimeline();
  return (
    <div className="grid gap-6">
      <header className="grid gap-2 border-b border-border pb-6">
        ...
        <p className="max-w-3xl text-muted-foreground">
          Collected, validated, reviewed, approved, and published evidence records for NVIDIA.
        </p>
      </header>
