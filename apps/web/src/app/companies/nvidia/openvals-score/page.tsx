...
import { fetchNvidiaOpenValsScore } from "@/lib/api";

export const metadata: Metadata = {
  title: "NVIDIA OpenVals Score | APIP",
  description: "NVIDIA company-level OpenVals Score from Gold Standard validation."
};

export default async function NvidiaOpenValsScorePage() {
  const score = await fetchNvidiaOpenValsScore();
  return (
